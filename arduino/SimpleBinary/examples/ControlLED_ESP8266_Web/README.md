## Example openHAB ESP8266 TCP binding implementation with web interface
...
Web interface is for user-friendly setting device address and for display custom information.
